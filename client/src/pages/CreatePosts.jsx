  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('http://localhost:8080/api/v1/imgai', {
          method: 'POST',
          headers: {
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
          Create imaginative and stunning images using AI
        </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>
            Once you've generated the desired image, you can share it to the community
          </p>
          <button
            type='submit'
